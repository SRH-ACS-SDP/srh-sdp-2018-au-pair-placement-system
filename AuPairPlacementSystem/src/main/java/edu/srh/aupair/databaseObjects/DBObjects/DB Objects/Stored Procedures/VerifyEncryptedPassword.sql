CREATE DEFINER=`root`@`localhost` PROCEDURE `VerifyEncryptedPassword`( 
in userName varchar(45),in personType varchar(45),
out userPassword VARCHAR(500), out pId int(10))
BEGIN
