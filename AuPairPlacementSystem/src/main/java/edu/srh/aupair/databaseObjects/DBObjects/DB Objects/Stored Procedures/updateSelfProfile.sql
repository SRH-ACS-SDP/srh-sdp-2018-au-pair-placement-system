...
IN EMAIL varchar(45),IN CONTACT varchar(45),IN ABOUTME varchar(45),IN TITLE varchar(45),
IN MARITALSTATUS varchar(45),IN INTERVIEW_TIME_SLOT varchar(45),IN PASSPORT varchar(45))
BEGIN
	...
	if(EMAIL<>'') THEN update PERSON set EMAIL=EMAIL where PERSON_ID=PERSONID;END IF;
...
if(PASSPORT<>'') THEN update PERSON set PASSPORT=PASSPORT where PERSON_ID=PERSONID;END IF;
if(TITLE<>'') THEN update PERSON set TITLE=TITLE where PERSON_ID=PERSONID;END IF;
-- INTERVIEW_TIME_SLOT
END
