...
public class BookingGUI {
	...
	{
		int AU_PAIR_ID = 22; //to do get this from search grid
 		...
 		ResultSet activeInterviewIds = serviceObj.getInterviewSlotForAuPair(interviewId, AU_PAIR_ID); //activeintwr
		...
		{
			System.out.println("There was some issue while scheduling the interview");
		}
